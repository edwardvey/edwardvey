...
exports.modules = {
  /***/ 3642: /***/ (
    ...
    var types_grid = __webpack_require__(105); // CONCATENATED MODULE: ../draw/pathRoundedRect.ts
    const pathRoundedRect_pathRoundedRect = (
      ctx,
      width,
      height,
      borderRadius,
      ...
      for (let x = grid.width; x--; )
        for (let y = grid.height; y--; ) {
          if (!cells || cells.some((c) => c.x === x && c.y === y)) {
            ...
            ctx.lineWidth = 1;
            ctx.beginPath();
            pathRoundedRect_pathRoundedRect(
              ctx,
              o.sizeDot,
              o.sizeDot,
              o.sizeDotBorderRadius,
            );
            ctx.fill();
            ctx.stroke();
            ctx.closePath();
    ...
    var types_snake = __webpack_require__(777); // CONCATENATED MODULE: ../solver/step.ts
    ...
    var external_gifsicle_default =
      /*#__PURE__*/ __webpack_require__.n(external_gifsicle_);
    // EXTERNAL MODULE: ../../node_modules/gif-encoder-2/index.js
    var gif_encoder_2 = __webpack_require__(1680);
    var gif_encoder_2_default =
      /*#__PURE__*/ __webpack_require__.n(gif_encoder_2); // CONCATENATED MODULE: ../gif-creator/index.ts
    // @ts-ignore
    ...
    const createGif = async (
      ...
      withTmpDir(async (dir) => {
        ...
        const stack = [];
        const encoder = new (gif_encoder_2_default())(
          width,
          height,
          "neuquant",
          true,
        ...
        const optimizedFileName = external_path_default().join(
          dir,
          "out.optimized.gif",
        );
        encoder.finish();
        external_fs_default().writeFileSync(outFileName, encoder.out.getData());
        (0, external_child_process_.execFileSync)(
          external_gifsicle_default(),
          [
            //
            "--optimize=3",
        ...
        return new Uint8Array(
          external_fs_default().readFileSync(optimizedFileName),
        );
      });
